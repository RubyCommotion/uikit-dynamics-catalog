describe DecorationView do
  ...
  describe 'DecorationView #init' do
    ...
    it 'should create an attachment_decoration_layers array of four UIImageViews' do
      puts ">>>>>>>> Controller is: #{controller.inspect}"
  ...
  describe 'DecorationView #layoutSubviews' do
    ...
    it 'should assign UIView\'s center point to arrow_view ImageView' do
      controller.arrow_view.center.x.should.equal CGRectGetMidX(controller.bounds)
      controller.arrow_view.center.y.should.equal CGRectGetMidY(controller.bounds)
    end
  ...
  describe 'DecorationView #hidden_dashes' do
    ...
    it 'for required dashes = 2 and max dashes = 4 should hide  elements 2 and 3 of the attachment_decoration_layers array (representing attachment dashes).' do
      controller.attachment_decoration_layers[0].hidden.should.equal false
      controller.attachment_decoration_layers[1].hidden.should.equal false
      controller.attachment_decoration_layers[2].hidden.should.equal true
      controller.attachment_decoration_layers[3].hidden.should.equal true
    end
